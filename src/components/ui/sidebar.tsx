...
const sidebarMenuButtonVariants = cva(
  // Updated base classes with rounded corners and subtle hover effects
  "peer/menu-button flex flex-col items-center gap-1 w-16 overflow-hidden p-2 text-sm outline-hidden ring-sidebar-ring transition-all rounded-xl hover:bg-card hover:shadow-sm focus-visible:ring-2 active:bg-card active:shadow-sm disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-card data-[active=true]:shadow-sm data-[active=true]:font-medium [&>svg]:size-4 [&>svg]:shrink-0 [&>span]:mt-1",
  {
    variants: {
      variant: {
