...
export const SecretSchema = z.object({
  value: z.string(),
  encryptionType: z.enum(["plaintext"]).optional(),
});
export type Secret = z.infer<typeof SecretSchema>;

/**
 * Zod schema for chat summary objects returned by the API
 */
...
/**
 * Zod schema for chat search result objects returned by the API
 */
...
// Zod schema for app search result objects returned by the API
