...
```bash
cat kova-plugin/templates/tanstack-start/TEMPLATE.md
cat kova-plugin/templates/tanstack-start/src/routes/__root.tsx
cat kova-plugin/skills/init-project/SKILL.md
```
...
```bash
rm -rf kova-plugin/templates/tanstack-start
cp -r /tmp/template-rebuild kova-plugin/templates/tanstack-start
```
...
```bash
# Edit kova-plugin/skills/init-project/SKILL.md
```
...
cp -r kova-plugin/templates/tanstack-start/* /tmp/template-test/
