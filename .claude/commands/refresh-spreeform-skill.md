...
```bash
cat packages/agent/src/skills/spreeform/SKILL.md
cat packages/agent/src/skills/spreeform/references/COMPONENTS.md
cat packages/agent/src/skills/spreeform/references/TOKENS.md
cat packages/agent/src/skills/spreeform/MAINTENANCE.md
```
