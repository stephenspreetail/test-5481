...
const TOKEN =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjIsImVtYWlsIjoidGVzdEB0ZXN0LmNvbSIsImlhdCI6MTc2NzA1NTU2MSwiZXhwIjoxNzY3MDYyNzYxfQ.KZYe9vGAt0hD7TEJLLjzJlKTU0nQ7sleEg7iZuU8hcc";
const CHAT_ID = 11;
...
ws.on("open", () => {
  ...
  const message = {
    ...
    chatId: CHAT_ID,
    prompt:
      "Create a simple login page with an email field, password field, and a submit button. Use plain HTML and CSS, no frameworks. Save it as index.html.",
  };
